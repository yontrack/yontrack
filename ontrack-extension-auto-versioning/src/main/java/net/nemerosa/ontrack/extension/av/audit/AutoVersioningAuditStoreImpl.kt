    ...
    internal fun saveEntry(entry: AutoVersioningAuditEntry) {
        ...
        val sql = """
            INSERT INTO AV_AUDIT (
                ...
                POST_PROCESSING, POST_PROCESSING_CONFIG, VERSION_RULE, VERSION_RULE_CONFIG, VALIDATION_STAMP,
                ...
                :postProcessing, CAST(:postProcessingConfig as JSONB), :versionRule, CAST(:versionRuleConfig as JSONB), :validationStamp,
        ...
        val params = mapOf(
            ...
            "versionRule" to entry.order.versionRule,
            "versionRuleConfig" to writeJson(entry.order.versionRuleConfig),
    ...
    private fun ResultSet.toEntry(): AutoVersioningAuditEntry {
        ...
        return AutoVersioningAuditEntry(
            order = AutoVersioningOrder(
                ...
                versionRule = getString("VERSION_RULE"),
                versionRuleConfig = readJson(this, "VERSION_RULE_CONFIG"),
